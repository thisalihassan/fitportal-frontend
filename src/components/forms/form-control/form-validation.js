					...
					<div className='col-sm-12'>
						...
						<div className='card'>
							<div className='card-header'>
								<h5>{Tooltips}</h5>
								<span>
									{'If your form layout allows it, you can swap the'} <code className='text-danger'>{'.feedback'}</code> {'classes for'}{' '}
									<code className='text-danger'>{'.tooltip'}</code>{' '}
									{'classes to display validation feedback in a styled tooltip. Be sure to have a parent with'}{' '}
									<code className='text-danger'>{'position: relative'}</code>{' '}
									{
