									...
									{plan && (
										<form className='theme-form'>
											...
											<div className='form-group'>
												...
												<input required className='form-control' type='text' name='planName' placeholder='sets' value={plan.planName} />
											</div>
												...
												return (
													<Fragment key={input + index}>
														...
														<div className='form-group'>
															...
															/>
															<input required value={input.set} className='form-control' type='text' name='set' placeholder='sets' />
															<input required value={input.weight} className='form-control' type='text' name='weight' placeholder='weights' />
															<input
																required
																className='form-control'
																type='text'
